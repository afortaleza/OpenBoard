...
#define QCHAR_HEX(hex) QChar(hex)
#define KEYBTDECL(s1, s2, clSwitch) KEYBT(QCHAR_HEX(s1), QCHAR_HEX(s2), clSwitch, 0, 0, KEYCODE(s1), KEYCODE(s2))
...
KEYBT FRENCH_LOCALE[] = {
    ...
    /* a A */ KEYBT(QCHAR_HEX(0x61), QCHAR_HEX(0x41), true, 0, 0, 0x61, 0x41, 0xe2, 0xc2, 0xe4, 0xc4),
    /* z Z */ KEYBTDECL(0x7a, 0x5a, true),
    /* e E */ KEYBT(QCHAR_HEX(0x65), QCHAR_HEX(0x45), true, 0, 0, 0x65, 0x45, 0xea, 0xca, 0xeb, 0xcb),
    /* r R */ KEYBTDECL(0x72, 0x52, true),
    /* t T */ KEYBTDECL(0x74, 0x54, true),
    /* y Y */ KEYBT(QCHAR_HEX(0x79), QCHAR_HEX(0x59), true, 0, 0, 0x79, 0x59, 0, 0, 0xff),
    /* u U */ KEYBT(QCHAR_HEX(0x75), QCHAR_HEX(0x55), true, 0, 0, 0x75, 0x55, 0xfb, 0xdb, 0xfc, 0xdc),
    /* i I */ KEYBT(QCHAR_HEX(0x69), QCHAR_HEX(0x49), true, 0, 0, 0x69, 0x49, 0xee, 0xce, 0xef, 0xcf),
    /* o O */ KEYBT(QCHAR_HEX(0x6f), QCHAR_HEX(0x4f), true, 0, 0, 0x6f, 0x4f, 0xf4, 0xd4, 0xf6, 0xd6),
    /* p P */ KEYBTDECL(0x70, 0x50, true),
    /* ^ ? */ KEYBT(QCHAR_HEX(0x5e), QCHAR_HEX(0xa8), true, 1, 2, 0x5e, 0xa8),
...
KEYBT SWISS_FRENCH_LOCALE[] = {
    ...
    /* ^ `*/    KEYBT(QCHAR_HEX(0x5e), QCHAR_HEX(0x60), false, 1, 2, 0x5e, 0x60),

    /* q Q*/    KEYBTDECL(0x71, 0x51, true),
    /* w W*/    KEYBTDECL(0x77, 0x57, true),
    /* e E*/    KEYBT(QCHAR_HEX(0x65), QCHAR_HEX(0x45), true, 0, 0, 0x65, 0x45, 0xea, 0xca, 0xe8, 0xc8, 0xeb, 0xcb),
    /* r R*/    KEYBTDECL(0x72, 0x52, true),
    /* t T*/    KEYBTDECL(0x74, 0x54, true),
    /* z Z*/    KEYBTDECL(0x7a, 0x5a, true),
    /* u U*/    KEYBT(QCHAR_HEX(0x75), QCHAR_HEX(0x55), true, 0, 0, 0x75, 0x55, 0xfb, 0xdb, 0xf9, 0xd9, 0xfc, 0xdc),
    /* i I*/    KEYBT(QCHAR_HEX(0x69), QCHAR_HEX(0x49), true, 0, 0, 0x69, 0x49, 0xee, 0xce, 0xec, 0xcc, 0xef, 0xcf),
    /* o O*/    KEYBT(QCHAR_HEX(0x6f), QCHAR_HEX(0x4f), true, 0, 0, 0x6f, 0x4f, 0xf4, 0xd4, 0xf2, 0xd2, 0xf6, 0xd6),
    /* p P*/    KEYBTDECL(0x70, 0x50, true),
    /* è ü*/    KEYBTDECL(0xe8, 0xfa, false),
    /* ¨ !*/    KEYBT(QCHAR_HEX(0xa8), QCHAR_HEX(0x21), false, 3, 0, 0xa8, 0x21),

    /* a A*/    KEYBT(QCHAR_HEX(0x61), QCHAR_HEX(0x41), true, 0, 0, 0x61, 0x41, 0xe2, 0xc2, 0xe0, 0xc0, 0xe4, 0xc4),
    /* s S*/    KEYBTDECL(0x73, 0x53, true),
    /* d D*/    KEYBTDECL(0x64, 0x44, true),
    /* f F*/    KEYBTDECL(0x66, 0x46, true),
    /* g G*/    KEYBTDECL(0x67, 0x47, true),
    ...
    /* y Y*/    KEYBT(QCHAR_HEX(0x79), QCHAR_HEX(0x59), true, 0, 0, 0x79, 0x59, 0, 0, 0, 0, 0xff),
    /* x X*/    KEYBTDECL(0x78, 0x58, true),
    /* c C*/    KEYBTDECL(0x63, 0x43, true),
    /* v V*/    KEYBTDECL(0x76, 0x56, true),
    /* b B*/    KEYBTDECL(0x62, 0x42, true),
